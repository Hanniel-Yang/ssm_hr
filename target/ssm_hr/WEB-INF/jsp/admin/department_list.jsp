...
<%--
										<a href="<%=path %>/department/<%=department.getId() %>/delete.do" class="btn btn-danger">删除</a>
--%>
										<a onclick="del(<%=department.getId() %>)" class="btn btn-danger delete">删除</a></td>
									</td>
								</tr>
							<%
                            		}
	...
	<script type="text/javascript">
		...
		function del(id){
			parent.layer.confirm('确认删除？', {
				...
				location.href="<%=path %>/department/"+ id +"/delete.do";
			});
		}
	</script>
</body>
